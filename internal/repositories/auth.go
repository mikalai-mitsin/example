...
func (r *JWTAuthRepository) Create(_ context.Context, user *models.User) (*models.TokenPair, error) {
    pair := r.createPair(user.ID)
    return pair, nil
}

func (r *JWTAuthRepository) createPair(subject string) *models.TokenPair {
    now := r.clock.Now().UTC()
...
func (r *JWTAuthRepository) Validate(_ context.Context, token models.Token) error {
...
func (r *JWTAuthRepository) RefreshToken(_ context.Context, token models.Token) (*models.TokenPair, error) {
    jwtToken, err := r.validate(token)
    if err != nil {
        return nil, err
    }
...
func (r *JWTAuthRepository) validate(token models.Token) (*jwt.Token, error) {
...
func (r *JWTAuthRepository) GetSubject(_ context.Context, token models.Token) (string, error) {
    jwtToken, err := jwt.Parse(token.String(), r.keyFunc)
    if err != nil {
...
func (r *JWTAuthRepository) keyFunc(_ *jwt.Token) (interface{}, error) {
