...
// Source: github.com/018bf/example/internal/app/session/usecases (interfaces: SessionRepository)
//
// Generated by this command:
//
//	mockgen -build_flags=-mod=mod -destination mock/interfaces.go . SessionRepository
//
