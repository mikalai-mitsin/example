...
// Source: github.com/mikalai-mitsin/example/internal/app/session/repositories/postgres (interfaces: Logger)
//
// Generated by this command:
//
//	mockgen -build_flags=-mod=mod -destination mock/logger.go . Logger
//
