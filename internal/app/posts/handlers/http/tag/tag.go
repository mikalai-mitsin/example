...
func (h *TagHandler) Delete(w http.ResponseWriter, r *http.Request) {
	...
	tag, err := h.tagUseCase.Delete(r.Context(), del)
	if err != nil {
		errs.RenderToHTTPResponse(err, w, r)
		return
	}
...
func (h *TagHandler) RegisterHTTP(httpServer *httpServer.Server) error {
	httpServer.Mount("/api/v1/posts/tags", h.router())
	return nil
}
