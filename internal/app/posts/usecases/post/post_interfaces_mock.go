...
func (m *MockpostService) Create(arg0 context.Context, arg1 post.PostCreate) (post.Post, error) {
	m.ctrl.T.Helper()
...
func (m *MockpostService) Update(arg0 context.Context, arg1 post.PostUpdate) (post.Post, error) {
	m.ctrl.T.Helper()
