...
func (o PostOrdering) Validate() error {
	if err := validation.Validate(o.String(), validation.In(PostOrderingCreatedAtDESC.String(), PostOrderingUpdatedAtASC.String(), PostOrderingUpdatedAtDESC.String(), PostOrderingBodyASC.String(), PostOrderingBodyDESC.String(), PostOrderingIdASC.String(), PostOrderingIdDESC.String(), PostOrderingCreatedAtASC.String())); err != nil {
		return err
	}
	return nil
}
