...
func (o PostOrdering) Validate() error {
	if err := validation.Validate(o.String(), validation.In(PostOrderingUpdatedAtDESC.String(), PostOrderingBodyASC.String(), PostOrderingBodyDESC.String(), PostOrderingIdASC.String(), PostOrderingIdDESC.String(), PostOrderingCreatedAtASC.String(), PostOrderingCreatedAtDESC.String(), PostOrderingUpdatedAtASC.String())); err != nil {
		return err
	}
	return nil
}
