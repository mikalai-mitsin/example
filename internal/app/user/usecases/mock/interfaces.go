...
// Source: github.com/018bf/example/internal/app/user/usecases (interfaces: UserRepository)
//
// Generated by this command:
//
//	mockgen -build_flags=-mod=mod -destination mock/interfaces.go . UserRepository
//
