...
// Source: github.com/mikalai-mitsin/example/internal/app/user/usecases (interfaces: UserRepository)
//
// Generated by this command:
//
//	mockgen -build_flags=-mod=mod -destination mock/repository.go . UserRepository
//
