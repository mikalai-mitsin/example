...
func (m *MockpostRepository) Create(arg0 context.Context, arg1 *entities.Post) error {
	m.ctrl.T.Helper()
...
func (m *MockpostRepository) Update(arg0 context.Context, arg1 *entities.Post) error {
	m.ctrl.T.Helper()
