...
// Source: github.com/mikalai-mitsin/example/internal/app/arch/handlers/grpc (interfaces: ArchInterceptor)
//
// Generated by this command:
//
//	mockgen -build_flags=-mod=mod -destination mock/interceptor.go . ArchInterceptor
//
