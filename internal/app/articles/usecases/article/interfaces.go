...
type articleService interface {
	...
	Delete(context.Context, dtx.TX, entities.ArticleDelete) (entities.Article, error)
}
type articleEventService interface {
	Send(context.Context, dtx.TX, entities.Article) error
}
