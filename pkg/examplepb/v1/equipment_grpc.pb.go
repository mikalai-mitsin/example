...
const (
	EquipmentService_Create_FullMethodName = "/examplepb.v1.EquipmentService/Create"
	EquipmentService_Get_FullMethodName    = "/examplepb.v1.EquipmentService/Get"
	EquipmentService_Update_FullMethodName = "/examplepb.v1.EquipmentService/Update"
	EquipmentService_Delete_FullMethodName = "/examplepb.v1.EquipmentService/Delete"
	EquipmentService_List_FullMethodName   = "/examplepb.v1.EquipmentService/List"
)
...
func (c *equipmentServiceClient) Get(ctx context.Context, in *EquipmentGet, opts ...grpc.CallOption) (*Equipment, error) {
	out := new(Equipment)
	err := c.cc.Invoke(ctx, EquipmentService_Get_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *equipmentServiceClient) Update(ctx context.Context, in *EquipmentUpdate, opts ...grpc.CallOption) (*Equipment, error) {
	out := new(Equipment)
	err := c.cc.Invoke(ctx, EquipmentService_Update_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *equipmentServiceClient) Delete(ctx context.Context, in *EquipmentDelete, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, EquipmentService_Delete_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *equipmentServiceClient) List(ctx context.Context, in *EquipmentFilter, opts ...grpc.CallOption) (*ListEquipment, error) {
	...
	err := c.cc.Invoke(ctx, EquipmentService_List_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _EquipmentService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EquipmentService_Get_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _EquipmentService_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EquipmentService_Update_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _EquipmentService_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EquipmentService_Delete_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _EquipmentService_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EquipmentService_List_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
